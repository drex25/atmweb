...
// Componente de métrica espacial con altura uniforme y mejor feedback
  ...
  return (
    ...
    >
      ...
      <div className={`relative h-[420px] rounded-3xl bg-gradient-to-br ${metric.bgGradient} backdrop-blur-xl border-2 shadow-2xl ${metric.glowColor} p-8 flex flex-col items-center justify-between hover:scale-105 hover:shadow-3xl transition-all duration-500 overflow-hidden group-hover:border-opacity-80`}
        ...
        {/* Sección central: Valor y etiqueta con mejor feedback */}
        <div className="flex flex-col items-center text-center flex-1 justify-center">
          <div className="text-6xl font-black mb-4 drop-shadow-xl relative z-10 group-hover:scale-110 transition-transform duration-300" style={{color: metric.color}}>
            <AnimatedCounter 
              value={metric.value} 
          ...
          <div className="text-xl font-bold mb-4 text-center text-white uppercase tracking-wide relative z-10 leading-tight group-hover:text-opacity-90 transition-all">
            {metric.label}
          </div>
        </div>
        ...
        <div className="w-full">
          <div className="text-sm text-white/90 text-center font-medium relative z-10 mb-6 leading-relaxed group-hover:text-white transition-colors">
            {metric.explanation}
          </div>
        ...
        {[...Array(150)].map((_, i) => (
          <div
            ...
            style={{
              ...
              backgroundColor: ['#ffffff', '#cyan', '#purple', '#pink'][Math.floor(Math.random() * 4)],
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
