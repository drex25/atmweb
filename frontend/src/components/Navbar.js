              ...
              <div key={item.name} className="relative group">
                ...
                >
                  ...
                  {item.mega && openMenu === item.name && (
                    ...
                    >
                      <div className="absolute left-1/2 transform -translate-x-1/2 mt-3 w-[520px] bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50">
                  ...
                  {!item.mega && item.submenu && openMenu === item.name && (
                    <Transition
                      ...
                      leaveTo="opacity-0 translate-y-2 scale-95"
                    >
                      <div className="absolute left-0 mt-3 w-64 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
                        <div className="py-2">
          ...
          <div className="max-w-7xl mx-auto">
            <form onSubmit={handleSearch} className="relative max-w-md mx-auto">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-atm-primary focus:border-transparent bg-white shadow-sm text-sm"
                autoFocus
              />
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setSearchTerm(e.target.value)}
                    placeholder="Buscar..."
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-atm-primary bg-gray-50"
                  />
                  <MagnifyingGlassIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                </div>
              </form>
