...
export default function HeroSellos({
  title = "SELLOS",
  description = "La autoliquidación de un trámite de sellado de manera individual y autónoma es posible; solo es necesario que usted, como contribuyente, tenga un usuario vigente en el sistema tributario y siga unos simples pasos.",
  backgroundImage = "/sellos.png",
  breadcrumbs = [
    { label: "ATM", active: false },
    { label: "Sellos", active: true },
  ],
}) {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 py-8 w-full">
        ...
        <p className="text-lg md:text-2xl text-white/90 mb-6 max-w-2xl drop-shadow font-medium">
          {description}
        </p>
